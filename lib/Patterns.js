...
var pathDelimit     = '[\\.#~\\(\\)+]';
var cpath       = '[\\w$\\.#~\\(\\)+]+';
var ctypes      = 'property|member|spare|module|class|interface|enum|throws|event';
var ctypesInner = 'property|member|spare|module|class|interface|enum|throws|event'
                 + '|callback|argument|kwarg|named|returns'
                 ;
...
//      +  util.format (
//             '@(%s|(?:%s(?:\\|%s)*))(?:/(%s(?:\\|%s)*))?[ \\t]*(%s)?',
//                inCT, cpath, cpath, cpath, cpath,        cpath
//         )
//      + '[ \\t]*\\r?[\\n\\r]((?:.|[\\n\\r])*)'
// );
