    ...
    for (var i in tpath) {
        ...
        if (isArr (location))
            if (step[1] && Object.hasOwnProperty.call (pointer[fragCType+'ByName'], step[1]))
                ...
                var newComponent = new Component (this, tpath.slice (0, i+1), pointer);
            ...
            pointer = location[fragName] = new Component (this, tpath.slice (0, i+1), pointer);
    }
...
ComponentCache.prototype.finalize = function (options, callback) {
    ...
    async.each (Object.keys (this.root.property), function (propname, callback) {
        self.root.property[propname].finalize (errors, warnings, options, callback);
    }, function(){
